...
// Programme Name  : register_screen_widgets.dart (Dart source file)
...
class _RegisterHeader extends StatelessWidget {
  const _RegisterHeader({required this.loading, required this.onBack});
  ...
  Widget build(BuildContext context) {
    return ResidentRegistrationHeader(
...
class _RegisterFormCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return ResidentRegistrationFormCard(
      formKey: formKey,
      children: [
